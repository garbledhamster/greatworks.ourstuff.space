...
export const BOOKS = [
  ...
  // Aeschylus
  mk(4,  "aeschylus-oresteia", "Aeschylus: The Oresteia", ["Aeschylus"], ["Agamemnon","Libation Bearers","Eumenides"], ["justice","fate","revenge","family","law","curse"], ["intense","catharsis","epic"], "long", {category:"imaginative", volume:4}),
  mk(4,  "aeschylus-prometheus", "Aeschylus: Prometheus Bound", ["Aeschylus"], ["Prometheus Bound"], ["rebellion","suffering","power","knowledge","tyranny","defiance"], ["intense","defiant"], "short", {category:"imaginative", volume:4}),
  mk(4,  "aeschylus-other", "Aeschylus: Other Plays", ["Aeschylus"], ["Suppliant Maidens","Persians","Seven Against Thebes"], ["war","fate","refuge","conflict"], ["intense","epic"], "medium", {category:"imaginative", volume:4}),

  // Sophocles
  mk(4,  "sophocles-oedipus-thebes", "Sophocles: Theban Plays", ["Sophocles"], ["Oedipus the King","Oedipus at Colonus","Antigone"], ["fate","truth","family","law","justice","suffering","pride"], ["intense","catharsis","profound"], "long", {category:"imaginative", volume:4}),
  mk(4,  "sophocles-ajax", "Sophocles: Ajax", ["Sophocles"], ["Ajax"], ["honor","madness","pride","death","shame"], ["tragic","intense"], "short", {category:"imaginative", volume:4}),
  mk(4,  "sophocles-electra", "Sophocles: Electra", ["Sophocles"], ["Electra"], ["revenge","justice","family","grief","duty"], ["intense","dark"], "short", {category:"imaginative", volume:4}),
  mk(4,  "sophocles-philoctetes", "Sophocles: Philoctetes", ["Sophocles"], ["Philoctetes"], ["suffering","betrayal","isolation","duty","honor"], ["reflective","painful"], "short", {category:"imaginative", volume:4}),

  // Euripides - Major plays
  mk(4,  "euripides-medea", "Euripides: Medea", ["Euripides"], ["Medea"], ["revenge","passion","betrayal","family","rage","justice"], ["intense","dark","psychological"], "short", {category:"imaginative", volume:4}),
  mk(4,  "euripides-bacchae", "Euripides: The Bacchae", ["Euripides"], ["Bacchae"], ["religion","madness","power","nature","dionysian","ecstasy"], ["intense","mystical","disturbing"], "short", {category:"imaginative", volume:4}),
  mk(4,  "euripides-hippolytus", "Euripides: Hippolytus", ["Euripides"], ["Hippolytus"], ["desire","purity","passion","fate","gods","destruction"], ["intense","tragic"], "short", {category:"imaginative", volume:4}),
  mk(4,  "euripides-trojan-women", "Euripides: Trojan Women", ["Euripides"], ["Trojan Women"], ["war","suffering","grief","loss","women","cruelty"], ["tragic","sorrowful","intense"], "short", {category:"imaginative", volume:4}),
  mk(4,  "euripides-alcestis", "Euripides: Alcestis", ["Euripides"], ["Alcestis"], ["death","sacrifice","love","marriage","loyalty"], ["moving","mixed"], "short", {category:"imaginative", volume:4}),
  mk(4,  "euripides-other", "Euripides: Other Plays", ["Euripides"], ["Electra","Hecuba","Heracles","Ion","Iphigenia in Aulis","Iphigenia in Tauris","Orestes","Phoenician Women","Suppliant Women","Andromache","Helen","Heracleidae","Rhesus","Cyclops"], ["fate","war","family","suffering","gods","women"], ["varied","intense","human"], "long", {category:"imaginative", volume:4}),

  // Aristophanes
  mk(4,  "aristophanes-lysistrata", "Aristophanes: Lysistrata", ["Aristophanes"], ["Lysistrata"], ["war","peace","sex","politics","women","satire"], ["funny","bawdy","clever"], "short", {category:"imaginative", volume:4, comfortTag:true}),
  mk(4,  "aristophanes-clouds", "Aristophanes: The Clouds", ["Aristophanes"], ["Clouds"], ["philosophy","education","satire","socrates","wisdom","folly"], ["funny","satirical"], "short", {category:"imaginative", volume:4, comfortTag:true}),
  mk(4,  "aristophanes-birds", "Aristophanes: The Birds", ["Aristophanes"], ["Birds"], ["utopia","fantasy","politics","escapism","satire"], ["funny","imaginative","light"], "short", {category:"imaginative", volume:4, comfortTag:true}),
  mk(4,  "aristophanes-frogs", "Aristophanes: The Frogs", ["Aristophanes"], ["Frogs"], ["art","poetry","death","judgment","comedy"], ["funny","literary"], "short", {category:"imaginative", volume:4, comfortTag:true}),
  mk(4,  "aristophanes-other", "Aristophanes: Other Comedies", ["Aristophanes"], ["Acharnians","Knights","Wasps","Peace","Poet and the Women"], ["politics","war","satire","society","humor"], ["funny","satirical","varied"], "medium", {category:"imaginative", volume:4, comfortTag:true}),
  ...
  mk(6,  "plato-gorgias", "Plato: Gorgias", ["Plato"], ["Gorgias"], ["rhetoric","justice","power","persuasion","good","sophistry"], ["inquiry","intense","serious"], "long", {category:"philosophy", volume:6}),
  mk(6,  "plato-crito", "Plato: Crito", ["Plato"], ["Crito"], ["law","duty","justice","obedience","conscience"], ["inquiry","clear","practical"], "short", {category:"philosophy", volume:6, comfortTag:true}),
  mk(6,  "plato-euthyphro", "Plato: Euthyphro", ["Plato"], ["Euthyphro"], ["piety","definition","religion","gods","virtue"], ["inquiry","accessible"], "short", {category:"philosophy", volume:6, comfortTag:true}),
  mk(6,  "plato-timaeus", "Plato: Timaeus", ["Plato"], ["Timaeus","Critias"], ["cosmology","nature","creation","world","form","matter"], ["systematic","mystical","deep"], "medium", {category:"philosophy", volume:6}),
  mk(6,  "plato-theaetetus", "Plato: Theaetetus", ["Plato"], ["Theaetetus"], ["knowledge","perception","truth","definition","wisdom"], ["inquiry","technical"], "medium", {category:"philosophy", volume:6}),
  mk(6,  "plato-protagoras", "Plato: Protagoras", ["Plato"], ["Protagoras"], ["virtue","teaching","sophistry","good","wisdom"], ["inquiry","engaging","accessible"], "medium", {category:"philosophy", volume:6, comfortTag:true}),
  mk(6,  "plato-ion", "Plato: Ion", ["Plato"], ["Ion"], ["poetry","art","inspiration","knowledge","skill"], ["inquiry","light"], "short", {category:"philosophy", volume:6, comfortTag:true}),
  mk(6,  "plato-other-dialogues", "Plato: Other Dialogues", ["Plato"], ["Cratylus","Laches","Lysis","Charmides","Euthydemus","Parmenides","Sophist","Statesman","Philebus","Laws"], ["wisdom","virtue","knowledge","truth","dialectic","language","courage","friendship"], ["inquiry","varied","technical"], "long", {category:"philosophy", volume:6}),
  ...
  mk(9,  "hippocrates", "Hippocrates: Medical Works", ["Hippocrates"], ["The Oath","On Ancient Medicine","Airs Waters Places","Prognostic","The Sacred Disease"], ["medicine","body","nature","health","ethics","cause"], ["practical","grounding","clear"], "medium", {category:"science", volume:9, comfortTag:true}),
  mk(9,  "galen", "Galen: On the Natural Faculties", ["Galen"], ["On the Natural Faculties"], ["medicine","body","nature","function","cause"], ["systematic","practical"], "short", {category:"science", volume:9}),
  // Volume 10: Greek Mathematics - broken down by author
  mk(10, "euclid-elements", "Euclid: Elements", ["Euclid"], ["Elements"], ["mathematics","geometry","proof","reasoning","form","logic"], ["calm","precise","foundational"], "long", {category:"science", volume:10}),
  mk(10, "archimedes-works", "Archimedes: Works", ["Archimedes"], ["On the Sphere and Cylinder","Measurement of a Circle","On Spirals","On Floating Bodies","The Sand Reckoner","The Method"], ["mathematics","physics","mechanics","proof","discovery"], ["precise","elegant","brilliant"], "long", {category:"science", volume:10}),
  mk(10, "nicomachus-arithmetic", "Nicomachus: Introduction to Arithmetic", ["Nicomachus"], ["Introduction to Arithmetic"], ["mathematics","number","quantity","theory"], ["accessible","foundational"], "short", {category:"science", volume:10}),
  ...
  mk(15, "ptolemy-almagest", "Ptolemy: The Almagest", ["Ptolemy"], ["The Almagest"], ["astronomy","mathematics","cosmos","observation","geocentric"], ["precise","systematic","foundational"], "long", {category:"science", volume:15}),
  mk(15, "copernicus-revolutions", "Copernicus: On the Revolutions", ["Copernicus"], ["On the Revolutions of the Heavenly Spheres"], ["astronomy","heliocentric","revolution","cosmos","science"], ["groundbreaking","precise","bold"], "long", {category:"science", volume:15}),
  mk(15, "kepler-astronomy", "Kepler: Harmonies & Epitome", ["Kepler"], ["Epitome of Copernican Astronomy","The Harmonies of the World"], ["astronomy","harmony","laws","mathematics","cosmos"], ["precise","mystical","mathematical"], "medium", {category:"science", volume:15}),
  ...
  mk(26, "gilbert-magnetism", "Gilbert: On the Loadstone", ["William Gilbert"], ["On the Loadstone and Magnetic Bodies"], ["magnetism","experiment","nature","earth","science"], ["curious","precise","foundational"], "medium", {category:"science", volume:26}),
  mk(26, "galileo-two-sciences", "Galileo: Two New Sciences", ["Galileo Galilei"], ["Dialogues Concerning Two New Sciences"], ["mechanics","motion","science","method","reasoning"], ["precise","groundbreaking","clear"], "long", {category:"science", volume:26}),
  mk(26, "harvey-circulation", "Harvey: On the Motion of the Heart", ["William Harvey"], ["On the Motion of the Heart and Blood"], ["medicine","body","circulation","experiment","discovery"], ["precise","foundational"], "short", {category:"science", volume:26}),
  ...
  mk(29, "milton-paradise-lost", "Milton: Paradise Lost", ["John Milton"], ["Paradise Lost"], ["good-and-evil","freedom","sin","fall","god","satan","will","rebellion"], ["epic","intense","sublime"], "long", {category:"imaginative", volume:29}),
  mk(29, "milton-samson", "Milton: Samson Agonistes", ["John Milton"], ["Samson Agonistes"], ["suffering","strength","faith","revenge","redemption","blindness"], ["tragic","intense","defiant"], "medium", {category:"imaginative", volume:29}),
  mk(29, "milton-poems", "Milton: Poetry & Prose", ["John Milton"], ["Lycidas","Comus","L'Allegro","Il Penseroso","Areopagitica","other poems"], ["beauty","virtue","freedom","censorship","contemplation","pastoral"], ["lyrical","varied"], "medium", {category:"imaginative", volume:29}),
  ...
  mk(31, "moliere-tartuffe", "Molière: Tartuffe", ["Molière"], ["Tartuffe"], ["hypocrisy","religion","deception","virtue-and-vice","family"], ["satirical","witty","sharp"], "short", {category:"imaginative", volume:31, comfortTag:true}),
  mk(31, "moliere-misanthrope", "Molière: The Misanthrope", ["Molière"], ["The Misanthrope"], ["honesty","society","love","truth","human-nature"], ["witty","satirical","human"], "short", {category:"imaginative", volume:31, comfortTag:true}),
  mk(31, "moliere-miser", "Molière: The Miser", ["Molière"], ["The Miser"], ["greed","money","family","love","obsession"], ["funny","satirical"], "short", {category:"imaginative", volume:31, comfortTag:true}),
  mk(31, "moliere-other", "Molière: Other Plays", ["Molière"], ["The School for Wives","Don Juan","The Would-Be Gentleman","The Imaginary Invalid"], ["society","pretension","class","marriage","satire"], ["witty","light","playful"], "medium", {category:"imaginative", volume:31, comfortTag:true}),
  mk(31, "racine-phedre", "Racine: Phèdre", ["Racine"], ["Phèdre"], ["passion","guilt","desire","fate","forbidden-love","tragedy"], ["intense","tragic","psychological"], "short", {category:"imaginative", volume:31}),
  mk(31, "racine-berenice", "Racine: Bérénice", ["Racine"], ["Bérénice"], ["love","duty","renunciation","state","sacrifice"], ["tragic","noble","restrained"], "short", {category:"imaginative", volume:31}),

  // Volume 32: Classical Mechanics - broken down by author
  mk(32, "newton-principia", "Newton: Principia & Optics", ["Isaac Newton"], ["Mathematical Principles of Natural Philosophy","Optics"], ["mechanics","gravity","motion","laws","light","mathematics","science"], ["precise","demanding","foundational","monumental"], "long", {category:"science", volume:32}),
  mk(32, "huygens-light", "Huygens: Treatise on Light", ["Christiaan Huygens"], ["Treatise on Light"], ["optics","light","waves","science","nature"], ["precise","clear"], "short", {category:"science", volume:32}),
  ...
  mk(34, "swift-gullivers-travels", "Swift: Gulliver's Travels", ["Jonathan Swift"], ["Gulliver's Travels"], ["satire","reason","human-nature","society","pride","folly"], ["witty","biting","clever"], "medium", {category:"imaginative", volume:34, comfortTag:true}),
  mk(34, "voltaire-candide", "Voltaire: Candide", ["Voltaire"], ["Candide"], ["optimism","suffering","satire","philosophy","evil","fate"], ["witty","sharp","accessible"], "short", {category:"imaginative", volume:34, comfortTag:true}),
  mk(34, "diderot-rameaus-nephew", "Diderot: Rameau's Nephew", ["Denis Diderot"], ["Rameau's Nephew"], ["morality","genius","society","paradox","art","self"], ["witty","philosophical","provocative"], "short", {category:"imaginative", volume:34, comfortTag:true}),
  ...
  mk(40, "american-founding-docs", "American Founding Documents", ["Various"], ["Declaration of Independence","Articles of Confederation","Constitution"], ["liberty","government","rights","democracy","law"], ["foundational","clear","inspiring"], "short", {category:"politics", volume:40}),
  mk(40, "federalist-papers", "The Federalist Papers", ["James Madison","Alexander Hamilton","John Jay"], ["The Federalist Papers"], ["government","constitution","federalism","republic","liberty","law"], ["analytical","practical","clear"], "long", {category:"politics", volume:40}),
  mk(40, "mill-liberty", "J.S. Mill: On Liberty & Others", ["John Stuart Mill"], ["On Liberty","Representative Government","Utilitarianism"], ["liberty","freedom","democracy","utility","individual","harm"], ["clear","practical","liberal"], "long", {category:"politics", volume:40}),
  ...
  mk(42, "lavoisier-chemistry", "Lavoisier: Elements of Chemistry", ["Antoine Lavoisier"], ["Elements of Chemistry"], ["chemistry","science","elements","experiment","method"], ["foundational","clear","revolutionary"], "medium", {category:"science", volume:42}),
  mk(42, "faraday-electricity", "Faraday: Experimental Researches in Electricity", ["Michael Faraday"], ["Experimental Researches in Electricity"], ["electricity","magnetism","science","experiment","discovery"], ["curious","precise","accessible"], "medium", {category:"science", volume:42}),
  ...
  mk(45, "goethe-faust", "Goethe: Faust", ["Johann Wolfgang von Goethe"], ["Faust Part I","Faust Part II"], ["desire","knowledge","good-and-evil","striving","redemption","love","ambition"], ["epic","philosophical","sublime"], "long", {category:"imaginative", volume:45}),
  mk(45, "balzac-cousin-bette", "Balzac: Cousin Bette", ["Honoré de Balzac"], ["Cousin Bette"], ["revenge","society","passion","family","ambition","money"], ["realistic","human","intense"], "long", {category:"imaginative", volume:45}),
  // Volume 46: 19th Century Novels - broken down by author
  mk(46, "austen-emma", "Austen: Emma", ["Jane Austen"], ["Emma"], ["love","society","judgment","custom","matchmaking","self-knowledge"], ["witty","comfort","human","warm"], "long", {category:"imaginative", volume:46, comfortTag:true}),
  mk(46, "eliot-middlemarch", "George Eliot: Middlemarch", ["George Eliot"], ["Middlemarch"], ["ambition","marriage","society","idealism","disillusionment","character"], ["wise","human","profound","comfort"], "long", {category:"imaginative", volume:46, comfortTag:true}),
  ...
  mk(50, "marx-capital", "Marx: Capital", ["Karl Marx"], ["Capital Vol. I"], ["labor","wealth","capitalism","exploitation","value","class"], ["demanding","systemic","analytical"], "long", {category:"social-science", volume:50}),
  mk(50, "marx-engels-manifesto", "Marx & Engels: Communist Manifesto", ["Karl Marx","Friedrich Engels"], ["Communist Manifesto"], ["revolution","class","capitalism","labor","state","history"], ["fiery","clear","provocative"], "short", {category:"social-science", volume:50}),
